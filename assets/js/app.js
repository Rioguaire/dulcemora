...
function buildProductCard(img, secNombre, subNombre, precioUSD, idx) {
    ...
    return '<div class="product-card" style="animation-delay:' + delay + 's">' +
        ...
        bcvHtml +
        '</div>' +
        '<a class="product-wa" href="https://wa.me/584242052925?text=' + encodeURIComponent(waMsg) + '" target="_blank" rel="noopener">' +
...
document.getElementById('whatsapp-btn')?.addEventListener('click', () => {
    window.open('https://wa.me/584242052925', '_blank');
});
...
function cotizarWhatsApp() {
    ...
    window.open('https://wa.me/584242052925?text=' + encodeURIComponent(msg), '_blank');
}
