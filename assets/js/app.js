...
function buildProductCard(img, secNombre, subNombre, precioUSD, idx) {
    ...
    return '<div class="product-card" style="animation-delay:' + delay + 's">' +
        '<div class="img-wrap"><div class="img-overlay"></div><img src="' + src + '" loading="lazy" onerror="this.style.display=\'none\'" oncontextmenu="return false">' +
        ...
        '</div>' +
        '</div>' +
        '<a class="product-wa" href="https://wa.me/584122052925?text=' + encodeURIComponent(waMsg) + '" target="_blank" rel="noopener">' +
...
document.getElementById('whatsapp-btn')?.addEventListener('click', () => {
    window.open('https://wa.me/584122052925', '_blank');
});
...
function cotizarWhatsApp() {
    ...
    window.open('https://wa.me/584122052925?text=' + encodeURIComponent(msg), '_blank');
}
